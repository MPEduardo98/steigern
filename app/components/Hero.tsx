  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className="text-zinc-500 dark:text-zinc-400 text-lg leading-relaxed flex-1">
        ...
        <motion.div
          ...
          className="flex flex-wrap gap-12 mt-20 pt-10 border-t border-zinc-200 dark:border-zinc-800"
        >
          {[
