...
export function generateMetadata(): Metadata {
  ...
  description: `STEIGERN diseña e integra soluciones de automatización industrial en México: perfiles de aluminio, conveyors, estaciones de trabajo, co-bots y más. ${yearsOfExperience()} años de experiencia. Presencia global.`,
  keywords: [
  ...
  openGraph: {
    ...
    // La imagen OG la genera app/opengraph-image.tsx (convención de archivo).
  },
  twitter: {
