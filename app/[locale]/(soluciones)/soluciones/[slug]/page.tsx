      ...
      <section className="relative w-full min-h-[55vh] flex items-end overflow-hidden bg-zinc-50">
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-8 lg:px-20 pb-16 pt-36">
          <div className="flex items-center gap-2 mb-6">
            ...
            <Link href="/soluciones" className="text-zinc-500 hover:text-zinc-800 text-xs tracking-[0.1em] uppercase transition-colors">Soluciones</Link>
            <span className="text-zinc-400 text-xs">/</span>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-zinc-400 text-xs tracking-[0.1em] uppercase">{solution.readingTime} de lectura</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-16 items-start">
            ...
            <aside className="lg:sticky lg:top-24 border border-zinc-200 p-7">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed mb-6">
                ¿Tienes un proyecto de {solution.title.toLowerCase()}? Cuéntanos tu caso y te asesoramos.
              </p>
              <Link href="/contacto"
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div className="max-w-xl">
              ...
              <p className="text-zinc-500 text-base leading-relaxed mt-4">
                Lo diseñamos, fabricamos e integramos a la medida de tu proceso.
              </p>
            </div>
            <Link href="/contacto"
